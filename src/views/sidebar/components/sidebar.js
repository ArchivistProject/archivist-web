...
export default class Sidebar extends Component {
    ...
    renderPanel() {
        const { visibleTab, activeItem, activeItemEditing, toggleEditMode, updateMetadata, saveMetadata, updateTags, editMode } = this.props;
        const summaryTabProps = { activeItem, activeItemEditing, toggleEditMode, updateMetadata, saveMetadata, updateTags, editMode };
        switch (visibleTab) {
